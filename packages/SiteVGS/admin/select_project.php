...
<body>
    ...
    <div class="choices form">
        <form method="POST">
            <table>
                <tr>
                    ...
                    <td>
                        <input data-cy="projects-list" list="Projet" class="text" name="name" id="name" />
                        <datalist id="Projet">
                            <?php
        ...
        <input data-cy="update-selected-project" class="input-select formchoice" type="submit" formmethod="post" name="formmodif" value="Modifier !">
    </form>
</div>
