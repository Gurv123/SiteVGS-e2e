...
<div class="choices form">
    ...
    <tr>
        <td>
            <input type="checkbox" name="delpseudo[]" id="delpseudo" value="<?= $donnees['pseudo'] ?>" data-cy="delete-member-team" >
        </td>
        <td>
            <label for="delpseudo" data-cy="pseudo-member-team"><?= $donnees['pseudo'] ?></label>
        </td>
    </tr>
    <?php endwhile; ?>
        </table>
