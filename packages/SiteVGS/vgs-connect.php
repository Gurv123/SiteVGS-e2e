...
<body>
    ...
    <div align="center">
        <h2>Connexion</h2>
        <br><br>
        <form method="POST" data-cy="login-form">
            <table>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <input autocomplete="off" class="text" type="password" placeholder="mot de passe"
                            name="mdpconnect" data-cy="login-password" />
                    </td>
                </tr>
            </table>
            <br><br>
    ...
    <div align="center" style="color: red;">
        <p><u>Si t'as pas de compte, inscris toi sur cette page <a style="color: darkred"
                    href="inscription.php">ici</a></u></p>
    </div>
